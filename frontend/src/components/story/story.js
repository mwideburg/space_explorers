          ...
          <Slider {...settings} className="slider">
            <div className="story-div">
              <p className="story-text">
                ...
                <p>
                  Global warming and melting ice caps revealed an ancient intact
                  alien ship that crashed in the arctic circle untold millennia
                  ago.
                </p>
            ...
            <div className="story-div">
              <p className="story-text">
                ...
                <p>
                  ...
                  build spaceships and settle other planets in the solar system.
                </p>
            ...
            <div className="story-div">
              <p className="story-text">
                <p>
                  ...
                  algorithms to devalue all the worlds currency and replaced it
                  with ℞osscoin.
                </p>
                <p>
                  Overnight he became the wealthiest person in history and every
                  nation on earth became a third world country.
                </p>
                <p>
                  Ross used his infinite resources to build a mega fortress on
                  Pluto and put a ℞60 Billion bounty on his own life, just to
                  troll everyone.
                </p>
              </p>
            </div>
            <div className="story-div">
              <p className="story-text">
                ...
                <p>
                  by devolving into a mercenary driven society ruled by whoever
                  had the biggest and coolest giant robot.{" "}
                </p>
                <img
                  className="mechimage"
